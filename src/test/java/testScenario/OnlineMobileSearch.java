...
public class OnlineMobileSearch {
	...
	{
		//No of pages validation in search results
	...
	{
		//No of items validation in search results
	...
	{
		//Clicking the element 'Sort By' on the web page
	...
	{
		//validation of counting options
	...
	{
		//Selection of Newest Arrival option 
